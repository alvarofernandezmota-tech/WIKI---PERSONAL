...
> 
> ⚠️ Este archivo fue movido a `docs/` el 2026-07-04 — es el mapa operativo.
> El documento de gobernanza (ley máxima) es `ECOSYSTEM-ARCHITECTURE.md` en raíz.
...
_Actualizado: 02-jul-2026 17:30 CEST — movido a docs/ el 04-jul-2026_
